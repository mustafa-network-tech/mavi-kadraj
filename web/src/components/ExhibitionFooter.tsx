...
export function ExhibitionFooter() {
  return <footer id="footer" className="v2-footer">
    ...
    <nav aria-label="Alt menü"><Link href="/kadraj-yansimalari">Kadraj Yansımaları</Link><Link href="/kadrajin-otesi">Kadrajın Ötesinde</Link><Link href="/mavi-kadraj-kimdir">Mavi Kadraj Kimdir</Link></nav>
